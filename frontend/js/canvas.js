const JadeCanvas = {
    jadeTypes: {
        '玉璧': (ctx, w, h) => JadeCanvas.drawBi(ctx, w, h),
        '玉琮': (ctx, w, h) => JadeCanvas.drawCong(ctx, w, h),
        '玉钺': (ctx, w, h) => JadeCanvas.drawYue(ctx, w, h),
        '玉璜': (ctx, w, h) => JadeCanvas.drawHuang(ctx, w, h),
        '玉珠': (ctx, w, h) => JadeCanvas.drawZhu(ctx, w, h),
        '玉管': (ctx, w, h) => JadeCanvas.drawGuan(ctx, w, h),
        '玉兽': (ctx, w, h) => JadeCanvas.drawShou(ctx, w, h),
        '玉鸟': (ctx, w, h) => JadeCanvas.drawNiao(ctx, w, h)
    },
